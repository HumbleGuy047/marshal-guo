...
import tempimg from "../pages/images/IMG_4717.jpg";
...
const BlogDetails = ({blog}) => {
    ...
    return (
<div className="blog-details bg-dark border rounded-sm p-4 text-white flex max-w-4xl mb-4 bg-gray-400">
  <div className="w-1/4">
    <div className="relative overflow-hidden" style={{ paddingBottom: '100%' }}>
      <img src={tempimg} alt="" className="object-cover absolute inset-0 w-full h-full" />
    </div>
  </div>
